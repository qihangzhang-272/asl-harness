...
def build(output: Path) -> Path:
    ...
    assets.mkdir()
    for name in ("package.json", "main.cjs", "preload.cjs", "bridge.cjs", "library.cjs", "native.cjs", "market.cjs", "assistant.cjs", "repository.cjs", "read-requests.cjs", "repository-import.cjs"):
